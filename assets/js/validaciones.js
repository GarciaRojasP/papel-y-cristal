export const validarFormulario = (inputTipo) => {
    ...
    if(input.validity.valid){
        ...
        input.parentElement.querySelector(".formulario__validacion-estado").classList.remove("uil-times-circle");
        input.parentElement.querySelector(".formulario__validacion-estado").classList.add("uil-check-circle");
        ...
        input.parentElement.querySelector(".formulario__validacion-estado").classList.remove("uil-check-circle");
        input.parentElement.querySelector(".formulario__validacion-estado").classList.add("uil-times-circle");
